    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostParagraphs", x => new { x.PostId, x.ParagraphId });
                    table.ForeignKey(
                        name: "FK_PostParagraphs_Paragraphs_ParagraphId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectParagraphs", x => new { x.ProjectId, x.ParagraphId });
                    table.ForeignKey(
                        name: "FK_ProjectParagraphs_Paragraphs_ParagraphId",
                        column: x => x.ParagraphId,
                        principalTable: "Paragraphs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectParagraphs_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostParagraphs_ParagraphId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectParagraphs_ParagraphId",
                table: "ProjectParagraphs",
                column: "ParagraphId");
